...
const config = {
  title: '用户操作文档',   //主页正中间标题
  tagline: '软件安装',   //主页下方按钮题目
  ...
  baseUrl: '/PublicDocument/',     

  //放在githubPage上使用的
  organizationName: 'Molly-0305', 
  projectName: 'PublicDocument', 
    ...
    [
      ...
      ({
        ...
        docs: {
          ...
          // editUrl: 'https://github.com/Molly-0305/PublicDocument/edit/source/'
        },
        theme: {
